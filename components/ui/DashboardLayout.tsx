  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-100 flex flex-col">
      ...
      <div className="flex flex-1 relative overflow-hidden">
        <aside className="w-64 flex-shrink-0 hidden md:block fixed top-16 bottom-0 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-black overflow-y-auto z-20">
          <Sidebar userRole={session.user.role as 'SUPER_ADMIN' | 'PARTNER'} userEmail={session.user.email || ''} />
        </aside>
        <main className="flex-1 md:ml-64 bg-gray-50 dark:bg-zinc-950 overflow-y-auto h-[calc(100vh-4rem)]">
