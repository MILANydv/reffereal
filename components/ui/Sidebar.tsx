...
const getPartnerNavigation = (appId: string | null): NavSection[] => {
  ...
  const appSection: NavSection = {
    ...
    items: [
      ...
      { name: 'Campaigns', href: `/dashboard/v2/campaigns?appId=${appId}`, icon: <Megaphone size={20} /> },
      { name: 'Referrals', href: `/dashboard/v2/referrals?appId=${appId}`, icon: <UserPlus size={20} /> },
      { name: 'Rewards', href: `/dashboard/v2/rewards?appId=${appId}`, icon: <CreditCard size={20} /> },
      { name: 'Analytics', href: `/dashboard/v2/analytics?appId=${appId}`, icon: <BarChart3 size={20} /> },
      { name: 'Webhooks', href: `/dashboard/v2/webhooks?appId=${appId}`, icon: <Webhook size={20} /> },
...
const adminNavigation: NavSection[] = [
  {
    ...
    items: [
      ...
      { name: 'Rewards', href: '/admin/v2/rewards', icon: <CreditCard size={20} /> },
