                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-5 py-4 rounded-2xl bg-slate-50 border-2 border-transparent focus:border-primary/20 focus:bg-white transition-all outline-none font-medium text-navy placeholder:text-slate-300 pr-14"
                      placeholder="••••••••••••"
                    />
                    <button
                      type="button"
