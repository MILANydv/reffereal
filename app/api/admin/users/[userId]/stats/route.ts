    ...
    const codesGeneratedWithStats = await Promise.all(
      referralCodesGenerated.map(async (ref) => {
        ...
        return {
          ...
          partnerId: ref.Campaign.App.Partner.id,
          partnerName: ref.Campaign.App.Partner.companyName,
          status: ref.status,
    ...
    return NextResponse.json({
      ...
      referralsReceived: referralsReceived.length > 0
        ? {
            ...
            partnerId: referralsReceived[0].Campaign.App.Partner.id,
            partnerName: referralsReceived[0].Campaign.App.Partner.companyName,
